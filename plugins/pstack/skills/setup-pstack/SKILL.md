...
This workflow only configures Cursor. If the current host is Codex or Grok Build, stop without writing files and direct the user to configure models in that host's settings.
