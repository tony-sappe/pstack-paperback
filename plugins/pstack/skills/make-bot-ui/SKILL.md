...
This workflow depends on Cursor automation routines and `api2.cursor.sh`. If the current host is not Cursor, stop before creating a webhook or writing configuration and explain that the workflow has not been ported.
