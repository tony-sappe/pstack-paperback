...
This version locates skills under `.cursor/skills/`. If the current host is Codex or Grok Build, stop before editing and explain that this maintenance flow has not been ported to that host's skill layout.
