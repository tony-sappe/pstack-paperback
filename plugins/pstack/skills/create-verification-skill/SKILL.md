...
This version writes project skills under `.cursor/skills/`. If the current host is Codex or Grok Build, stop before creating files and explain that its output path is Cursor-specific.
