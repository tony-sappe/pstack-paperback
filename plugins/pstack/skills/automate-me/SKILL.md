...
This workflow uses Cursor transcript paths and Cursor's built-in `create-skill` flow. On Codex or Grok Build, stop before reading history or writing files and explain that this authoring flow has not been ported.
