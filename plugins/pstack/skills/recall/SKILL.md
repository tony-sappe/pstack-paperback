...
This workflow's transcript search is Cursor-specific. If the current host does not provide the Cursor workspace transcript path named below, stop and say that personal chat-history recall is unavailable; do not search another host's private data directories by guessing.
