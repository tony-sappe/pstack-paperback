...
Use the current host's available runners. Inherit the parent model unless the user specifies another available model and follow the **arena** skill's host-native selection rules.
